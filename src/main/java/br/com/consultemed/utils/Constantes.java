...
public class Constantes {
	...
	public static final String MEDICO_SUCESSO = "  cadastrado(a) com sucesso";
	public static final String MEDICO_REMOVIDO = "  médico removido com sucesso";
	public static final String MEDICO_EDITADO = "  alterado(a) com sucesso";

	//MENSAGENS DA TELA AGENDAMENTOS
	public static final String AGENDAMENTO = " agendamento";
	public static final String AGENDAMENTO_SUCESSO = "  cadastrado(a) com sucesso";
	public static final String AGENDAMENTO_REMOVIDO = "  agendamento removido com sucesso";
	public static final String AGENDAMENTO_EDITADO = "  alterado(a) com sucesso";
